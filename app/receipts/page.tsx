...
export default function ReceiptsPage() {
  ...
  if (isError) {
    return (
      <div className="max-w-md mx-auto p-4 sm:p-8 text-center mt-12">
        <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100">
          ...
          <button
            ...
            className="w-full bg-blue-600 text-white px-6 py-3.5 rounded-xl font-bold shadow-md hover:bg-blue-700 transition-all active:scale-95 cursor-pointer"
          >
            Try Again
          </button>
        </div>
