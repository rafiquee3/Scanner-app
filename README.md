...
- **Receipt Editor**: Review, modify, or add items to your parsed receipt before securely saving it to your account.
- **Cloud Storage & Sync**: All data is securely stored using Supabase (Auth & PostgreSQL). Access your receipts from anywhere.
